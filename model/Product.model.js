...
virtual.get(function () {                // Yeh code "id" virtual property ke liye ek getter function set karta hai.
  return this._id;                       // Jab bhi aap product.id access karenge, yeh this._id ke value ko return karega.
});

productSchema.set("toJSON", {            // Yeh code toJSON method ke liye kuch configurations set karta hai.
